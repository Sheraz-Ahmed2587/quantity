						...
						<div class="row g-3">
							<form method="POST" action="action.php" enctype="multipart/form-data">
								...
								<div class="col-sm-12 mt-3">
									...
									<input type="date" class="form-control" id="basicInput" name="date">
								</div>
								...
								<div class="row mt-3">
									<div class="col-md-4 mx-auto">
										<button class="btn btn-success w-100" type="submit" name="add_blog">Submit</button>
									</div>
								</div>
							</form>
						</div>
