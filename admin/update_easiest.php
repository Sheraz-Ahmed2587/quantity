...
$id=$_GET['id'];
$data="SELECT * FROM easiest WHERE id='$id'";
...
<div class="main-content">
	...
	<div class="main-content">
		<div class="dashboard-breadcrumb mb-25">
			<h2>Update Easiest To Sell Fields</h2>
		</div>
		<div class="row">
			<div class="col-lg-12">
							...
							<form method="POST" action="action.php" enctype="multipart/form-data">
								...
								<div class="row mt-4">
									<div class="col-md-4 mx-auto">
										<button class="btn btn-success w-100" name="update_easiest" type="submit">Update</button>
									</div>
								</div>
							</form>
						</div>
